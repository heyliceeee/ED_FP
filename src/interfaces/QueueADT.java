...
/**
 * A interface QueueADT define o contrato para uma Queue abstrata.
 * Uma fila é uma coleção linear de elementos que segue o princípio FIFO (First In, First Out), em que o primeiro elemento inserido é o primeiro a ser removido.
 *
 * Esta interface fornece operações básicas de enfileiramento, desenfileiramento, inspeção do primeiro elemento, verificação de tamanho e se a fila está vazia, além de gerar uma representação textual da fila.
 *
